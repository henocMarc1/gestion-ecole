-- FIX: Fonction check_overdue_payments avec correction de l'alias
-- Exécutez ce SQL dans Supabase SQL Editor pour corriger l'erreur
...
BEGIN
    ...
    SELECT 
        ...
        COALESCE(
            (SELECT (tf_inner.amount - tf_inner.paid_amount)
